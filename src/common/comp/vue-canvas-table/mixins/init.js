...
export default {
  ...
  methods: {
    ...
    // 设置canvas
    setCanvas (boxHeight) {
      const { ratio, canvas, cHeight, box,showVScrollbar } = this
      let oldWidth = box.offsetWidth
      let oldHeight = showVScrollbar?cHeight-10:cHeight
      canvas.width = oldWidth * ratio
      canvas.height = oldHeight * ratio
      // canvasBox.style.height = boxHeight - 12 + 'px'
      // canvasBox.style.marginTop = '6px'
